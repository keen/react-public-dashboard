...
var Viewer = function Viewer(props) {
  ...
  var container = react__WEBPACK_IMPORTED_MODULE_0___default.a.createRef();
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    var url = "https://keen.io/dashboard/".concat(dashboardId);
    fetch(url).then(function (res) {
      return res.json();
    }).then(function (data) {
      var masterKey = accessKey;
      var dashboardInfo = data;
      var myDashboardViewer = new DashboardViewer({
        container: ".".concat(container.current.className),
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "keen-dashboard-viewer",
    ref: container
  });
};
...
Viewer.propTypes = {
  dashboardId: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string.isRequired,
  projectId: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string.isRequired,
  accessKey: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string.isRequired
};
